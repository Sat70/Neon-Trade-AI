...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        const response = await fetch(`${ML_SERVICE_BASE_URL}/risk?ticker=${encodeURIComponent(tickerParam)}&horizon=${encodeURIComponent(horizonParam)}`, { signal: controller.signal });
        ...
        return res.status(502).json({
            message: 'Failed to reach ML risk service.',
