...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        const response = await fetch(`${ML_SERVICE_BASE_URL}/predict?ticker=${encodeURIComponent(tickerParam)}&horizon=${encodeURIComponent(horizonParam)}`, { signal: controller.signal });
